...
class AttributionEngine:
    ...
    def __init__(self, fingerprints_path: str, embeddings_path: str = None):
        ...
        self.embeddings_path = embeddings_path or fingerprints_path.replace('.json', '_embeddings.pkl')
        self.logger = logger
    ...
    def _load_fingerprints(self):
        ...
        try:
            ...
            self.logger.info(f"Loaded {len(self.fingerprints_db.get('families', []))} attribution families")
    ...
    def update_fingerprints(self, family_name: str, features: Dict[str, float], 
        ...
        try:
            family = None
            for f in self.fingerprints_db["families"]:
            ...
            if family is None:
                ...
                self.fingerprints_db["families"].append(family)
...
class EmbeddingIndex:
    ...
    def _rebuild_index(self):
        """Rebuild index when feature names change"""
        self.index = None
        self.family_labels = []
