...
class ForensicReportGenerator:
    ...
    def generate_comprehensive_report(self, analysis_result: Dict[str, Any],
                                    ...
                                    case_info: Optional[Dict[str, Any]] = None) -> Dict[str, str]:
    ...
    def _generate_html_report(self, analysis_result: Dict[str, Any],
                            case_info: Optional[Dict[str, Any]] = None) -> str:
...
<body>
    ...
    def _generate_pdf_report(self, analysis_result: Dict[str, Any],
                           case_info: Optional[Dict[str, Any]], pdf_path: str,
                           original_image_path: Optional[str] = None) -> None:
        ...
        try:
            ...
            story: List[Any] = []  # Flowable-like list for ReportLab
    ...
    def _get_overall_probability(self, analysis_result: Dict[str, Any]) -> float:
        ...
        # Prefer canonical deep model score; fall back to legacy compatibility field if present
        deep_score = scores.get('deep_model_score')
        legacy_score = scores.get('legacy_deepfake_score')

        if deep_score is not None:
            return float(deep_score)
    ...
    def _get_primary_indicators(self, analysis_result: Dict[str, Any]) -> List[str]:
        ...
        if scores.get('legacy_deepfake_score', 0) > 0.7:
